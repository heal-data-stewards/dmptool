...
# themes = [
#   {title: 'Objectives'},
#   {title: 'Standards, Regulations and Policy'},
#   {title: 'Data Lifecycle – Preservation, Access and Associated Timelines'},
#   {title: 'Data Types'},
#   {title: 'Data security'},
#   {title: 'Ethical aspects'},
#   {title: 'Compliance with Regulations / Privacy Law'},
#   {title: 'Data Quality'},
#   {title: 'Data archiving and destruction'},
#   {title: 'Tools, Software and Code '},
#   {title: 'Data Sharing Agreements, Licenses and Other Use Limitations'},
#   {title: 'Data Governance – Oversight of Data Governance'},
# ]
...
#    abbreviation: "HEAL",
#    org_type: 4, links: {"org":["https://heal.nih.gov"]},
#    language: none, region: region,
...
#    published: true,
#    themes: [Theme.find_by(title: 'Objectives')]},
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Standards, Regulations and Policy')]},
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Data Lifecycle – Preservation, Access and Associated Timelines')]},
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Data Types')]},
...
# # -------------------------------------------------------
# templates = [
#   {title: "NIH HEAL DMP Default Template",
#    description: "The HEAL default template",
#    published: true,
#    org: "HEAL",
#    is_default: true, locale: default_locale,
#    version: 0,
#    visibility: Template.visibilities[:publicly_visible],
#    links: {"funder":["nih.gov"],"sample_plan":["nih.gov/sample"]}},
# ]
...
# # -------------------------------------------------------
# phases = [
#   {title: "HEAL Generic Data Management Planning Template",
#    number: 1,
#    modifiable: false,
#    template: Template.find_by(title: "NIH HEAL DMP Default Template")}
# ]
# phases.each{ |p| Phase.create!(p) }

# generic_template_phase_1 = Phase.find_by(title: "HEAL Generic Data Management Planning Template")
...
#   {text: "Data Management and Sharing Plan (Plan): A plan describing how scientific data will be managed, preserved, and shared with others (e.g., researchers, institutions, the broader public), as appropriate.",
#    number: 1,
#    section: Section.find_by(title: "Objectives"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Objectives")]},
#   {text: "Describe in two pages or less the proposed approach to data management and sharing that the specific research will employ.",
#    number: 2,
#    section: Section.find_by(title: "Objectives"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Objectives")]},
#   {text: "What Standards to be applied to data and metadata?",
#    number: 1,
#    section: Section.find_by(title: "Standards, Regulations and Policy"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Standards, Regulations and Policy")]},
#   {text: "Record lifecycle - describe the physical and technical pathways and requirements for data that are ingested?",
#    number: 1,
#    section: Section.find_by(title: "Data Lifecycle – Preservation, Access and Associated Timelines"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Lifecycle – Preservation, Access and Associated Timelines")]},
#   {text: "Describe the types, amount/size of data collected",
#    number: 1,
#    section: Section.find_by(title: "Data Types"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Types")]},
#   {text: "Provide rationale for decisions about preservation and sharing of data
#   Identify metadata and associated documentation.",
#    number: 2,
#    section: Section.find_by(title: "Data Types"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Types")]},
#   {text: "Define how data is managed and shared within the program. Define program and kinds of data to be shared, and expectation of types of data access and controls.",
#    number: 3,
#    section: Section.find_by(title: "Data Types"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Types")]},
#   {text: "Address data recovery as well as secure storage and transfer of sensitive data",
#    number: 1,
#    section: Section.find_by(title: "Data security"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data security")]},
#   {text: "Incident response - describe the procedures the award recipient will follow in the event of a real or suspected breach of data including PII that are collected or maintained in conjunction with the program?",
#    number: 2,
#    section: Section.find_by(title: "Data security"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data security")]},
#   {text: "Ethical aspects covered in the context of the ethics review, ethics section of DoA and ethics deliverables. Include references and related technical aspects if not covered by the former",
#    number: 1,
#    section: Section.find_by(title: "Ethical aspects"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Ethical aspects")]},
...
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Sharing")]},
#   {text: "Refer to other national/funder/sectorial law applied to data",
#    number: 1,
#    section: Section.find_by(title: "Compliance with Regulations / Privacy Law"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Compliance with Regulations / Privacy Law")]},
#   {text: "Define steps taken to ensure data quality and accuracy throughout the data life cycle",
#    number: 1,
#    modifiable: false,
#    section: Section.find_by(title: "Data Quality"),
#    question_format: text_area,
#    themes: [Theme.find_by(title: "Data Quality")]},
#   {text: "Describe the data elements, how the data will be prepared for archiving and what level of access will be assigned, e.g., as public use files, restricted access, or other.",
#    number: 1,
#    section: Section.find_by(title: "Data archiving and destruction"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data archiving and destruction")]},
#   {text: "Describe costs and potential value of long term preservation",
#    number: 2,
#    section: Section.find_by(title: "Data archiving and destruction"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data archiving and destruction")]},
#   {text: "Tools required for access, sharing, replication, reuse",
#    number: 1,
#    section: Section.find_by(title: "Tools, Software and Code "),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Tools, Software and Code ")]},
#   {text: "An indication of the individual(s) who will be responsible for executing various components (e.g., data collection, data analysis, data submission) of the Plan over the course of the research project and the roles of the individual(s) in data management, and a description of the appropriate expertise for oversight",
#    number: 1,
#    section: Section.find_by(title: "Data Governance – Oversight of Data Governance"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Data Governance – Oversight of Data Governance")]},
#   {text: "Program team - List the program team members (including the individuals tasked with drafting and overseeing the DMP), identify their roles, and provide their contact information",
#    number: 2,
#    section: Section.find_by(title: "Data Governance – Oversight of Data Governance"),
#    question_format: text_area,
#    modifiable: false,
...
# # -------------------------------------------------------
# annotations = [
#   {text: "We will refer to the HEAL Data Standards Documentation",
#    type: Annotation.types[:example_answer],
#    org: Org.find_by(abbreviation: 'HEAL'),
#    question: Question.find_by(text: "What Standards to be applied to data and metadata?")},
...
# themes = [
#   {title: 'Data Type'},
#   {title: 'Related Tools, Software and/or Code'},
#   {title: 'Standards'},
#   {title: 'Data Preservation, Access, and Associated Timelines'},
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Data Type')]},
#   {text: "● Clearly note what format(s) your data will be in, e.g., plain text (.txt), comma-separated values (.csv), geo-referenced TIFF (.tif, .tfw).
# ● Explain why you have chosen certain formats. Decisions may be based on staff expertise, a preference for open formats, the standards accepted by data centres or widespread usage within a given community.
# ● Using standardised, interchangeable or open formats ensures the long-term usability of data; these are recommended for sharing and archiving.
# ● See <a href='https://www.ukdataservice.ac.uk/manage-data/format/recommended-formats' title='UK Data Service guidance on recommended formats'>UK Data Service guidance on recommended formats</a> or <a href='https://www.dataone.org/best-practices/document-and-store-data-using-stable-file-formats' title='DataONE Best Practices for file formats'>DataONE Best Practices for file formats</a>",
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Related Tools, Software and/or Code')]},
#   {text: "● Note what volume of data you will create in MB/GB/TB
# ● Consider the implications of data volumes in terms of storage, access and preservation. Do you need to include additional costs?
# ● Consider whether the scale of the data will pose challenges when sharing or transferring data between sites; if so, how will you address these challenges?",
#    guidance_group: GuidanceGroup.first,
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Standards')]},
#   {text: "● What metadata will be provided to help others identify and discover the data?
# ● Researchers are strongly encouraged to use community metadata standards where these are in place. The Research Data Alliance offers a <a href='http://rd-alliance.github.io/metadata-directory' title='Directory of Metadata Standards'>Directory of Metadata Standards</a>.
# ● Consider what other documentation is needed to enable reuse. This may include information on the methodology used to collect the data, analytical and procedural information, definitions of variables, units of measurement, any assumptions made, the format and file type of the data and software used to collect and/or process the data.
# ● Consider how you will capture this information and where it will be recorded, e.g., in a database with links to each item, in a ‘readme’ text file, in file headers, etc. ",
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Data Preservation, Access, and Associated Timelines')]},
#   {text: "● Investigators carrying out research involving human participants should request consent to preserve and share the data. Do not just ask for permission to use the data in your study or make unnecessary promises to delete it at the end.
# ● Consider how you will protect the identity of participants, e.g., via anonymisation or using managed access procedures.
# ● Ethical issues may affect how you store and transfer data, who can see/use it and how long it is kept. You should demonstrate that you are aware of this and have planned accordingly.
# ● See <a href='https://www.ukdataservice.ac.uk/manage-data/legal-ethical/consent-data-sharing' title='UK Data Service guidance on consent for data sharing'>UK Data Service guidance on consent for data sharing</a>
...
#    guidance_group: GuidanceGroup.first,
#    published: true,
#    themes: [Theme.find_by(title: 'Roles & Responsibility')]},
#   {text: "● Consider whether there are any existing procedures that you can base your approach on. If your group/department has local guidelines that you work to, point to them here.
# ● List any other relevant funder, institutional, departmental or group policies on data management, data sharing and data security. ",
#    guidance_group: GuidanceGroup.first,
#    published: true,
...
#    number: 1,
#    section: Section.find_by(title: "Metadata & Documentation"),
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Metadata & Documentation")]},
...
#    question_format: text_area,
#    modifiable: false,
#    themes: [Theme.find_by(title: "Storage & Security"), Theme.find_by(title: 'Data Type')]},
#   {text: "What are your institution's ethical policies?",
#    number: 1,
#    section: Section.find_by(title: "Ethical Standards"),
#    question_format: text_area,
...
themes = [
  ...
  {title: 'Standards'},
  {title: 'Data Preservation, Access, and Associated Timelines'},
  {title: 'Access, Distribution, or Reuse Considerations'},
...
● Consider how you will capture this information and where it will be recorded, e.g., in a database with links to each item, in a ‘readme’ text file, in file headers, etc. ",
   guidance_group: GuidanceGroup.first,
   published: true,
   themes: [Theme.find_by(title: 'Access, Distribution, or Reuse Considerations')]},
  {text: "● Investigators carrying out research involving human participants should request consent to preserve and share the data. Do not just ask for permission to use the data in your study or make unnecessary promises to delete it at the end.
● Consider how you will protect the identity of participants, e.g., via anonymisation or using managed access procedures.
● Ethical issues may affect how you store and transfer data, who can see/use it and how long it is kept. You should demonstrate that you are aware of this and have planned accordingly.
● See <a href='https://www.ukdataservice.ac.uk/manage-data/legal-ethical/consent-data-sharing' title='UK Data Service guidance on consent for data sharing'>UK Data Service guidance on consent for data sharing</a>
● See <a href='http://www.icpsr.umich.edu/icpsrweb/content/datamanagement/confidentiality/index.html' title='ICPSR approach to confidentiality'>ICPSR approach to confidentiality</a> and Health Insurance Portability and Accountability Act <a href='https://privacyruleandresearch.nih.gov/' title='(HIPAA) regulations for health research'>(HIPAA) regulations for health research</a>",
   guidance_group: GuidanceGroup.first,
   published: true,
   themes: [Theme.find_by(title: 'Oversight of Data Management and Sharing')]},
  {text: "● State who will own the copyright and IPR of any new data that you will generate. For multi-partner projects, IPR ownership should be covered in the consortium agreement.
● Outline any restrictions needed on data sharing, e.g., to protect proprietary or patentable data.
● Explain how the data will be licensed for reuse. See the <a href='http://www.dcc.ac.uk/resources/how-guides/license-research-data' title='DCC guide on How to license research data'>DCC guide on How to license research data</a> and <a href='https://ufal.github.io/public-license-selector' title='EUDAT’s data and software licensing wizard'>EUDAT’s data and software licensing wizard</a>.",
   guidance_group: GuidanceGroup.first,
...
questions = [
  # Questions for the Generic Template
  {text: "What data will you collect or create as part of your HEAL work?",
   number: 1,
   section: Section.find_by(title: "Data Collection"),
   question_format: text_area,
   modifiable: false,
  ...
  {text: "What types/formats of data will you collect?",
   number: 1,
   modifiable: true,
   section: Section.find_by(title: "Data Type"),
   question_format: text_area,
   themes: [Theme.find_by(title: "Related Tools, Software and/or Code")]},
  {text: "How will you store the data and how will it be preserved?",
   number: 2,
  ...
  {text: "What types of data will you collect and how will it be stored?",
   ...
   question_format: text_area,
   modifiable: false,
   themes: [Theme.find_by(title: "Storage & Security"), Theme.find_by(title: 'Related Tools, Software and/or Code')]},
  {text: "What are your institution's ethical policies?",
   number: 1,
   section: Section.find_by(title: "Ethical Standards"),
   question_format: text_area,
